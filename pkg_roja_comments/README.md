...
ROJA Comments adalah sistem komentar native untuk Joomla yang otomatis muncul di halaman artikel tanpa perlu shortcode atau pengaturan manual per artikel.
...
- Komponen ROJA Comments terpasang
- Plugin Content - ROJA Comments aktif
...
4. Pilih file pkg_roja_comments.zip.
...
2. Cari plugin Content - ROJA Comments.
3. Ubah statusnya menjadi Enabled.
4. Buka Components → ROJA Comments → Options.
...
2. Buka Components → ROJA Comments.
3. Lihat daftar komentar yang masuk.
4. Approve, reject, spam, atau delete sesuai kebutuhan.

## Jika tidak muncul
- Pastikan plugin Content - ROJA Comments aktif.
- Pastikan component ROJA Comments terinstall dengan benar.
...
2. Nonaktifkan plugin ROJA Comments.
3. Hapus extension ROJA Comments dari daftar install.
